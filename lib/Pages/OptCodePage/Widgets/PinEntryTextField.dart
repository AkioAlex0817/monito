...
class PinEntryTextField extends StatefulWidget {
  ...
  PinEntryTextField({Key key, this.lastPin, this.fields: 4, this.onSubmit, this.fieldWidth: 40.0, this.fontSize: 16.0, this.isTextObscure: false, this.showFieldAsBox: false})
      : assert(fields > 0),
        super(key: key);
