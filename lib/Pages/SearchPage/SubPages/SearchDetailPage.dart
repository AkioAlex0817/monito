...
class SearchDetailPage extends StatefulWidget {
  ...
  SearchDetailPage({Key key, @required this.searchModel}) : super(key: key);
...
class _SearchDetailPageState extends State<SearchDetailPage> {
  ...
  _addFavorite() async {
    ...
    var response = await HttpHelper.authPost(context, url, {'asin': widget.searchModel.asin}, {}, false);
    if (mounted) {
      if (response != null) {
        ...
        if (result['result'] == "success") {
          setState(() {
            _isLoading = false;
            widget.searchModel.isFavorite = true;
          });
  ...
  _removeFavorite() async {
    ...
    String url = Constants.URL + "api/wishlist?asin=" + widget.searchModel.asin;
    ...
    if (mounted) {
      if (response != null) {
        ...
        if (result['result'] == "success") {
          setState(() {
            _isLoading = false;
            widget.searchModel.isFavorite = false;
          });
          Helper.showToast(LangHelper.SUCCESS, true);
        } else {
          _errorHandler();
                                  ...
                                  SizedBox(
                                    ...
                                    child: Container(
                                      ...
                                      child: AspectRatio(
                                        aspectRatio: 1,
                                        child: Hero(
                                          tag: "search_image_${widget.searchModel.asin}",
                                          child: CachedNetworkImage(
                                            placeholder: (context, url) => CupertinoActivityIndicator(radius: 10),
                                            imageUrl: widget.searchModel.photo,
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          SizedBox(
                                            height: 60,
                                            child: Hero(
                                              tag: "search_title_${widget.searchModel.asin}",
                                              child: Container(
                                          ...
                                          SizedBox(
                                            ...
                                            child: Container(
                                              ...
                                              child: Text(widget.searchModel.category_name, style: TextStyle(color: Colors.red, fontSize: 14, fontWeight: FontWeight.bold)),
                                            ),
                                          ),
                                          SizedBox(
                                            height: 20,
                                            child: Container(
                                              ...
                                              child: Material(
                                                ...
                                                child: InkWell(
                                                  onLongPress: () {
                                                    Helper.clipBoardWidget(widget.searchModel.asin, context);
                                                  },
                                                  child: Text(
                                                    "ASIN: ${widget.searchModel.asin}",
                                          ...
                                          SizedBox(
                                            ...
                                            child: Container(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  Text(
                                                    "JAN: ${Helper.isNullOrEmpty(widget.searchModel.jan) ? '--' : widget.searchModel.jan}",
                                                    style: TextStyle(color: Colors.black54, fontSize: 12, fontWeight: FontWeight.bold),
                                                  ),
                                                ],
                                              ),
                              ...
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Container(
                                    ...
                                    child: Text(
                                      sprintf("%s位", [widget.searchModel.sales_rank.formatter]),
                              ...
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Container(
                                    alignment: Alignment.centerRight,
                                    child: Text(
                                      sprintf("%s円", [widget.searchModel.amazon_price.formatter]),
                                      style: TextStyle(color: Colors.black, fontSize: 14, fontWeight: FontWeight.bold),
                                    ),
                                  ),
                                )
                              ...
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Container(
                                    alignment: Alignment.centerRight,
                                    child: Text(
                                      sprintf("%s円", [widget.searchModel.new_price.formatter]),
                                      style: TextStyle(color: Colors.black, fontSize: 14, fontWeight: FontWeight.bold),
                                    ),
                                  ),
                                )
                              ...
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Container(
                                    alignment: Alignment.centerRight,
                                    child: Text(
                                      sprintf("%s円", [widget.searchModel.used_price.formatter]),
                                      style: TextStyle(color: Colors.black, fontSize: 14, fontWeight: FontWeight.bold),
                                    ),
                                  ),
                                )
                      ...
                      child: SizedBox(
                        ...
                        child: Center(
                          child: CachedNetworkImage(
                            ...
                            imageUrl: "https://graph.keepa.com/pricehistory.png?asin=" + widget.searchModel.asin + "&domain=co.jp&salesrank=1&width=600&height=200&range=90",
                            errorWidget: (context, url, error) => Icon(Icons.error, color: Colors.red),
                          ),
                        ),
                      ),
                          ...
                          children: [
                              ...
                              child: LoadingButton(
                                ...
                                onPressed: () {
                                  Navigator.push(
                                      ...
                                      PageTransition(
                                          child: WebPage(
                                            url: "https://sellercentral.amazon.co.jp/product-search/search?q=${widget.searchModel.asin}&ref_=xx_addlisting_dnav_home",
                                          ),
                            ...
                            Expanded(
                              ...
                              child: LoadingButton(
                                ...
                                disabled: _isLoading,
                                loading: _isLoading,
                                title: widget.searchModel.isFavorite ? "登録解除" : "お気に入り",
                                fontColor: Colors.white,
                                fontSize: 15,
                                loadingColor: Colors.black,
                                loadingSize: 20,
                                borderRadius: 10,
                                onPressed: () {
                                  if (widget.searchModel.isFavorite) {
                                    _removeFavorite();
                                  } else {
                                    _addFavorite();
                                  }
                              ...
                              child: LoadingButton(
                                ...
                                onPressed: () {
                                  Navigator.push(
                                    ...
                                    PageTransition(
                                      child: WebPage(
                                        url: Constants.AmazonURL + widget.searchModel.asin,
                                      ),
                                      type: PageTransitionType.bottomToTop,
                                      inheritTheme: true,
                                      curve: Curves.easeIn,
          ...
          child: Stack(
            children: [
              ...
              Container(
                ...
                color: Colors.white,
                child: ZoomOverlayWidget(asin: widget.searchModel.asin),
              )
            ],
          ),
        ),
